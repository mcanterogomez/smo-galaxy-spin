...
public:
    ...
    void startUpperBodyAnim(const sead::SafeString& animName);
    void startUpperBodyAnimAndHeadVisKeep(const sead::SafeString& animName);
    void startUpperBodyAnimSubParts(const sead::SafeString& animName);
    ...
    bool isUpperBodyAnim(const sead::SafeString& animName) const;
