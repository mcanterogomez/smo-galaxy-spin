...
public:
    ...
    void startSubAnimOnlyAir(const sead::SafeStringBase<char>& animName);
    void startUpperBodyAnimAndHeadVisKeep(const sead::SafeStringBase<char>& animName);

    void startUpperBodyAnim(const sead::SafeStringBase<char>& animName);
    bool isUpperBodyAnimEnd();
    bool isUpperBodyAnim(const sead::SafeStringBase<char>& animName);
    ...
    bool isSubAnim(const sead::SafeStringBase<char>& animName) const;
...
public:
    ...
    sead::SafeString mCurrentAnim;
    unsigned char padding_78[0x78 - 0x30];
    sead::SafeString mCurrentSubAnim;
};